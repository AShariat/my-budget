  ...
  window.scrollTo(0, 0);
    ...
    return (
      ...
      <article class="blog-post">
        <h2 class="blog-post-title">I didnt know where the money went!</h2>
        <p class="blog-post-meta">May 18, 2021 by Old Couple</p>
  ...
  window.scrollTo(0, 0); 
    ...
    return (
      ...
      <article class="blog-post">
        ...
        <p class="blog-post-meta">December 23, 2020 by Old Couple</p>
