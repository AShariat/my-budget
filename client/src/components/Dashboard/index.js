    ...
    <div className="container-fluid">
      <div className="row">
        <main role="main" className="col-md-12 ml-sm-auto col-lg-12 pt-3 px-4">
          <div className="chartjs-size-monitor" style={Style5}>
            <div className="chartjs-size-monitor-expand" style={Style3}>
              <div style={Style4}></div>
            </div>
            <div className="chartjs-size-monitor-shrink" style={Style3}>
          ...
          <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            ...
            <div className="btn-toolbar mb-2 mb-md-0">
              <div className="btn-group mr-2">
                ...
                <div className="btn btn-sm btn-outline-secondary bg-secondary text-light mr-3 rounded">
                  Current User Amount
                </div>
                <button
                  className="btn btn-sm btn-outline-secondary rounded"
                  onClick={() => {
                    props.changeFunction("UserInputModal");
                  }}
                >
                  Add more?
                </button>
