        ...
        <main role="main">
            ...
            <section className="jumbotron text-center">
                <div className="container">
                    <h1 className="jumbotron-heading">Why are Irish bankers so successful? Because their capital’s always Dublin!</h1>
                    <p className="lead text-muted">Below you will find some made up statements from our made up customers! They love our app, and you should too!</p>
                    <p>
                        <a onClick={() => { props.changeFunction('About')}} className="btn btn-light my-2 mx-2">Learn more about us!</a>
                        <a onClick={() => { props.changeFunction('Login')}} className="btn btn-secondary text-white my-2 mx-2">Login, or sign up!</a>
                    </p>
                </div>
            </section>
                        ...
                        <div className="col-md-4">
                            <div className="card mb-4 box-shadow">
                                ...
                                <div className="card-body">
                                    <p className="card-text">This is one of the schmucks we scammed out of all his money-- I mean, one of our loyal customers, who's VERY happy with us!</p>
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="btn-group">
                                            <button type="button" className="btn btn-sm btn-outline-secondary" onClick={() => {props.changeFunction('Customer1')}}>Read their story!</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-md-4">
                            <div className="card mb-4 box-shadow">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="btn-group">
                                            <button type="button" className="btn btn-sm btn-outline-secondary" onClick={() => {props.changeFunction('Customer2')}}>Read her story!</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-md-4">
                            <div className="card mb-4 box-shadow">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="btn-group">
                                            <button type="button" className="btn btn-sm btn-outline-secondary" onClick={() => {props.changeFunction('Customer3')}}>Read his story!</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
