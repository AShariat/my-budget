            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content rounded-5 shadow">
                    <div className="modal-header p-2 pb-2 border-bottom-0">
                        ...
                        <button type="button" className="btn-close bg-light rounded" data-bs-dismiss="modal" aria-label="Close"><i className="bi bi-x-lg"></i></button>
                    </div>
                    ...
                    <div className="dropdown d-flex column" style={centerContainer}>
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a className="dropdown-item" href="#">Another Category</a>
                            <a className="dropdown-item" href="#">Some other Category</a>
                        </div>
                    </div>
                    ...
                    <div className="modal-body p-5 pt-0">
                        <form>
                            <div className="form-floating mb-1">
                                <input type="totalInput" className="form-control rounded-4" id="floatingTotalInput" placeholder="Enter Expenditure Here" />
                                <label for="floatingTotalInput"></label>
                            </div>
                            <div className="form-floating mb-1">
                                <input type="description" className="form-control rounded-4" id="floatingDescription" placeholder="Description" />
                            ...
                            <button className="w-100 mb-2 btn btn-lg rounded-4 btn-secondary" type="submit">Cancel</button>
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content rounded-6 shadow">
                    <div className="modal-header border-bottom-0">
                        ...
                        <button type="button" className="btn-close rounded bg-light" data-bs-dismiss="modal" aria-label="Close"><i className="bi bi-x-lg"></i></button>
                    </div>
                    ...
                    <div className="modal-footer flex-column border-top-0">
                        <button type="button" className="btn btn-lg btn-primary w-100 mx-0 mb-2" onClick={() => { props.changeFunction('Login')}}>Login</button>
      ...
      <div className="modal-body p-4 pt-0">
        <form className="">
          <div className="form-floating mb-3">
            <input type="email" className="form-control rounded-4" id="floatingInput" placeholder="First Name" />
            <label for="floatingInput"></label>
          </div>
          <div className="form-floating mb-3">
            <input type="email" className="form-control rounded-4" id="floatingInput" placeholder="Last Name" />
            <label for="floatingInput"></label>
          </div>
          <div className="form-floating mb-3">
            <input type="email" className="form-control rounded-4" id="floatingInput" placeholder="Email address" />
            <label for="floatingInput"></label>
          </div>
          <div className="form-floating mb-3">
