    ...
    <section>
      <div className="jumbotron">
        <div className="container">
          ...
          <p><a className="btn btn-primary btn-lg bg-light border-light" onClick={() => { props.changeFunction('Testimonials')}} role="button">Listen to our happy customers! »</a></p>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <p><a className="btn btn-secondary" href="https://www.wsj.com/articles/best-ways-for-couples-to-manage-finances-11644264301?page=1" role="button">View details »</a></p>
          </div>
          <div className="col-md-4">
            ...
            <p><a className="btn btn-secondary" href="https://www.news8000.com/beware-of-scam-apps/" role="button">View News Details »</a></p>
          </div>
        </div>
      </div>
      <br></br>
